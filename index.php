...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="vendors/images/apple-touch-icon2.png">
    <link rel="icon" type="image/png" sizes="32x32" href="vendors/images/apple-touch-icon2.png">
    <link rel="icon" type="image/png" sizes="16x16" href="vendors/images/apple-touch-icon2.png">
    ...
    <div class="login-header box-shadow">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="brand-logo">
                <a href="signin.php">
                    <img src="vendors/images/apple-touch-icon2.png" alt="">
                </a>
            </div>
